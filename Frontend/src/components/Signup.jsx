            ...
            <div className='flex h-screen items-center justify-center'>
                <form onSubmit={handleSubmit(onSubmit)} className='border border-white px-6 py-2 rounded-md space-y-3 w-96'>
                    ...
                    <label className="input input-bordered flex items-center gap-2">
                        ...
                        <input type="text" className="grow" placeholder="Fsername"
...
{errors.confirmPassword && <span className="text-red-500">{errors.confirmPassword.message}</span>}
                    <div className='flex  justify-between'>
                        ...
                        <input type='submit' value='Sign Up' className='text-white bg-green-500 px-2 py-1 cursor-pointer rounded-lg' />
                    </div>
                </form>
            </div>
        </>
